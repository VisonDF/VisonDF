                         ...
                         const unsigned int strt_vl) 
{
    ...
    if constexpr (IsBool) {
        ...
        apply_numeric_filter_boolmask<MapCol>(bool_v, 
                                              n, 
                                              0, 
                                              f, 
                                              mask,
        ...
        apply_numeric_filter_boolmaks<MapCol>(int_v, 
                                              n, 
                                              3, 
                                              f, 
                                              mask,
        ...
        apply_numeric_filter_boomask<MapCol>(uint_v, 
                                             n, 
                                             4, 
                                             f, 
                                             mask,
        ...
        apply_numeric_filter_boolmask<MapCol>(dbl_v, 
                                              n, 
                                              5, 
                                              f, 
                                              mask,
