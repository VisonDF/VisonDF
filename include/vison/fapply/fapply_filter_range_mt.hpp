                            ...
                            const unsigned int strt_vl) 
{
    ...
    if constexpr (IsBool) {
        ...
        apply_numeric_filter_boolmask<MapCol, CORES>(bool_v, 
                                                     n, 
                                                     0, 
                                                     f, 
                                                     mask,
        ...
        apply_numeric_filter_boolmaks<MapCol, CORES>(int_v, 
                                                     n, 
                                                     3, 
                                                     f, 
                                                     mask,
        ...
        apply_numeric_filter_boomask<MapCol, CORES>(uint_v, 
                                                    n, 
                                                    4, 
                                                    f, 
                                                    mask,
        ...
        apply_numeric_filter_boolmask<MapCol, CORES>(dbl_v, 
                                                     n, 
                                                     5, 
                                                     f, 
                                                     mask,
        ...
        for (size_t i = strt_vl; i < strt_vl + end; ++i)  {
            if (!mask[i]) continue;
            f(dst[i]);
        }
