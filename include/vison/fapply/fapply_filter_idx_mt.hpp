                          ...
                          const std::vector<unsigned int>& mask) 
{
    ...
    if constexpr (IsBool) {
        ...
        apply_numeric_filter_idx<MapCol, CORES>(bool_v, 
                                                n, 
                                                0, 
                                                f, 
                                                mask);
        ...
        apply_numeric_filter_idx<MapCol, CORES>(int_v, 
                                                n, 
                                                3, 
                                                f, 
                                                mask);
        ...
        apply_numeric_filter_idx<MapCol, CORES>(uint_v, 
                                                n, 
                                                4, 
                                                f, 
                                                mask);
        ...
        apply_numeric_filter_idx<MapCol, CORES>(dbl_v, 
                                                n, 
                                                5, 
                                                f, 
                                                mask);
        ...
        #pragma omp pralel for if(CORES > 1) num_threads(CORES)
