        ...
        for (size_t i = 0; i < type_refv.size(); i += 1) {
            ...
            switch (type_refv[i]) {
                  ...
                  case 'b': {
                                ...
                                insert_column(bool_v.back().data(), 
                                              bool_vec2[i].data(), 
                                              refv_tmp, 
                                              cur_tmp2);
                                break;
                  ...
                  case 'u': {
                                ...
                                insert_column(uint_v.back().data(), 
                                              uint_vec2[i].data(), 
                                              refv_tmp, 
                                              cur_tmp2);
                                break;
