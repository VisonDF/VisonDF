...
void fapply_simd_filter_boolmask(F f, 
                                 unsigned int& n, 
                                 ...
                                 const unsigned int strt_vl) 
{
    ...
    if constexpr (IsBool) {
        ...
        apply_numeric_simd_filter_range<uint8_t>(bool_v, 
                                                 n, 
                                                 0, 
                                                 f, 
                                                 mask,
        ...
        apply_numeric_simd_filter_range<IntT>(int_v, 
                                              n, 
                                              3, 
                                              f, 
                                              mask,
        ...
        apply_numeric_simd_filter_range<UIntT>(uint_v, 
                                               n, 
                                               4, 
                                               f, 
                                               mask,
        ...
        apply_numeric_simd_filter_range<FloatT>(dbl_v, 
                                                n, 
                                                5, 
                                                f, 
                                                mask,
