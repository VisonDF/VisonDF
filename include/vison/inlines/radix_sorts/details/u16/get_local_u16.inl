...
inline std::array<size_t, RADIX_KI16>& get_local_count_u16() {
    static std::array<size_t, RADIX_KI16> local;
    return local;
}
...
{
    static std::array<std::array<size_t, RADIX_KI16>, MAX_THREADS> local;
    return local;
}
...
{
    static std::array<size_t, RADIX_LANES * RADIX_KI16> local_hist;
    return local_hist.data();
}

inline size_t* get_local_histogram_16x_u16()
{
    static std::array<size_t, RADIX_LANES_AVX512 * RADIX_KI16> local_hist;
    return local_hist.data();
}
