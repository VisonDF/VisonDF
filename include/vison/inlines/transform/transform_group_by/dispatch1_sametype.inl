...
inline void dispatch1_sametype(auto&& f,
                               const size_t start, 
                               const size_t end, 
                               auto& cmap,
